...
public:
	...
	void print(); // Print list from 1st to last nodes.
	bool remove(int p1, int p2); // Remove a range of nodes from positioin p1 to p2 (inclusive). Returns true for successful removal and false for illegal params for p1 and/or p2.
...
void List<T>::print()
{
	...
	while (pCurrentNode != NULL)
		// print the item currently pointed to in the list
		std::cout << get_next() << " ";
	std::cout << std::endl;
}
